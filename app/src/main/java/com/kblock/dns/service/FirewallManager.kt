...
import com.kblock.dns.service.FirewallManager.GlobalVariable.appInfos
import com.kblock.dns.service.FirewallManager.GlobalVariable.appInfosLiveData
import com.kblock.dns.service.FirewallManager.GlobalVariable.foregroundUids
...
object FirewallManager : KoinComponent {
    ...
    fun updateFirewallStatus(
        ...
        Log.i(
            LOG_TAG_FIREWALL,
            "Apply firewall rule for uid 2 : ${uid}, ${firewallStatus.name}, ${connectionStatus.name}"
        )
        io {
